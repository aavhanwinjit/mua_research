...
import 'package:ekyc/core/dependency/injection.dart' as _i32;
...
import 'package:ekyc/features/profile/domain/repositories/profile_repository.dart'
    as _i16;
import 'package:ekyc/features/profile/domain/usecases/logout.dart' as _i30;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i27.LaunchDetails>(
        () => _i27.LaunchDetails(gh<_i23.SplashScreenRepository>()));
    gh.lazySingleton<_i28.LoginByFP>(
        () => _i28.LoginByFP(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i29.LoginByMpin>(
        () => _i29.LoginByMpin(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i30.Logout>(
        () => _i30.Logout(gh<_i16.ProfileRepository>()));
    gh.lazySingleton<_i31.SaveFile>(
        () => _i31.SaveFile(gh<_i19.SaveFileRepository>()));
    return this;
  }
}

class _$MAUEngineModule extends _i32.MAUEngineModule {}

...
import 'package:ekyc/core/dependency/injection.dart' as _i48;
...
import 'package:ekyc/features/profile/domain/usecases/get_agent_details.dart'
    as _i46;
import 'package:ekyc/features/profile/domain/usecases/logout.dart' as _i47;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i28.AuthRepository>(
        () => _i29.AuthRepositoryImpl(apiService: gh<_i10.ApiService>()));
    gh.lazySingleton<_i30.ChangeMPIN>(
        () => _i30.ChangeMPIN(gh<_i28.AuthRepository>()));
    gh.lazySingleton<_i31.ResendOTP>(
        () => _i31.ResendOTP(gh<_i28.AuthRepository>()));
    gh.lazySingleton<_i32.ValidateOTP>(
        () => _i32.ValidateOTP(gh<_i28.AuthRepository>()));
    gh.lazySingleton<_i33.VerifyMobileNumber>(
        () => _i33.VerifyMobileNumber(gh<_i28.AuthRepository>()));
    gh.lazySingleton<_i34.LoginByFP>(
        () => _i34.LoginByFP(gh<_i15.MPINRepository>()));
    gh.lazySingleton<_i35.LoginByMpin>(
        () => _i35.LoginByMpin(gh<_i15.MPINRepository>()));
    gh.lazySingleton<_i36.SetAgentMPIN>(
        () => _i36.SetAgentMPIN(gh<_i15.MPINRepository>()));
    gh.lazySingleton<_i37.SetFingerPrint>(
        () => _i37.SetFingerPrint(gh<_i15.MPINRepository>()));
    gh.lazySingleton<_i38.VerifyMPIN>(
        () => _i38.VerifyMPIN(gh<_i15.MPINRepository>()));
    gh.lazySingleton<_i39.LaunchDetails>(
        () => _i39.LaunchDetails(gh<_i17.SplashScreenRepository>()));
    gh.lazySingleton<_i40.SaveSignatureRepository>(() =>
        _i41.SaveSignatureRepositoryImpl(apiService: gh<_i10.ApiService>()));
    gh.lazySingleton<_i42.GetAgentApplications>(() =>
        _i42.GetAgentApplications(gh<_i11.AgentApplicationsRepository>()));
    gh.lazySingleton<_i43.GetKycTypes>(
        () => _i43.GetKycTypes(gh<_i19.KycTypesRepository>()));
    gh.lazySingleton<_i44.SaveSignature>(
        () => _i44.SaveSignature(gh<_i40.SaveSignatureRepository>()));
    gh.lazySingleton<_i45.DeRegisterFingerprint>(
        () => _i45.DeRegisterFingerprint(gh<_i26.ProfileRepository>()));
    gh.lazySingleton<_i46.GetAgentDetails>(
        () => _i46.GetAgentDetails(gh<_i26.ProfileRepository>()));
    gh.lazySingleton<_i47.Logout>(
        () => _i47.Logout(gh<_i26.ProfileRepository>()));
    return this;
  }
}

class _$MAUEngineModule extends _i48.MAUEngineModule {}

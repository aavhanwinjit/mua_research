...
import 'package:ekyc/core/dependency/injection.dart' as _i62;
...
import 'package:ekyc/features/profile/domain/usecases/get_agent_details.dart'
    as _i60;
import 'package:ekyc/features/profile/domain/usecases/logout.dart' as _i61;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i56.SaveIdentityDetails>(
        () => _i56.SaveIdentityDetails(gh<_i47.SaveDocumentInfoRepository>()));
    gh.lazySingleton<_i57.AddCustomerInformation>(() =>
        _i57.AddCustomerInformation(gh<_i33.AddCustomerInfoRepository>()));
    gh.lazySingleton<_i58.SaveSignature>(
        () => _i58.SaveSignature(gh<_i49.SaveSignatureRepository>()));
    gh.lazySingleton<_i59.DeRegisterFingerprint>(
        () => _i59.DeRegisterFingerprint(gh<_i31.ProfileRepository>()));
    gh.lazySingleton<_i60.GetAgentDetails>(
        () => _i60.GetAgentDetails(gh<_i31.ProfileRepository>()));
    gh.lazySingleton<_i61.Logout>(
        () => _i61.Logout(gh<_i31.ProfileRepository>()));
    return this;
  }
}

class _$MAUEngineModule extends _i62.MAUEngineModule {}

...
import 'package:ekyc/core/dependency/injection.dart' as _i33;
...
import 'package:ekyc/features/profile/domain/usecases/de_register_fingerprint.dart'
    as _i27;
import 'package:ekyc/features/profile/domain/usecases/logout.dart' as _i31;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i28.LaunchDetails>(
        () => _i28.LaunchDetails(gh<_i23.SplashScreenRepository>()));
    gh.lazySingleton<_i29.LoginByFP>(
        () => _i29.LoginByFP(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i30.LoginByMpin>(
        () => _i30.LoginByMpin(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i31.Logout>(
        () => _i31.Logout(gh<_i16.ProfileRepository>()));
    gh.lazySingleton<_i32.SaveFile>(
        () => _i32.SaveFile(gh<_i19.SaveFileRepository>()));
    return this;
  }
}

class _$MAUEngineModule extends _i33.MAUEngineModule {}

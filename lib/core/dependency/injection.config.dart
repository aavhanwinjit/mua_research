...
import 'package:ekyc/core/dependency/injection.dart' as _i44;
...
import 'package:ekyc/features/profile/domain/usecases/get_agent_details.dart'
    as _i36;
import 'package:ekyc/features/profile/domain/usecases/logout.dart' as _i40;
...
import 'package:ekyc/features/signature/domain/repositories/view_file_repository.dart'
    as _i30;
import 'package:ekyc/features/signature/domain/usecases/save_file.dart' as _i41;
import 'package:ekyc/features/signature/domain/usecases/save_signature.dart'
    as _i42;
import 'package:ekyc/features/signature/domain/usecases/view_file.dart' as _i43;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i21.SaveSignatureRepository>(() =>
        _i22.SaveSignatureRepositoryImpl(apiService: gh<_i11.ApiService>()));
    gh.lazySingleton<_i23.SetAgentMPIN>(
        () => _i23.SetAgentMPIN(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i24.SetFingerPrint>(
        () => _i24.SetFingerPrint(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i25.SplashScreenRepository>(() =>
        _i26.SplashScreenRepositoryImpl(apiService: gh<_i11.ApiService>()));
    gh.lazySingleton<_i27.ValidateOTP>(
        () => _i27.ValidateOTP(gh<_i12.AuthRepository>()));
    gh.lazySingleton<_i28.VerifyMPIN>(
        () => _i28.VerifyMPIN(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i29.VerifyMobileNumber>(
        () => _i29.VerifyMobileNumber(gh<_i12.AuthRepository>()));
    gh.lazySingleton<_i30.ViewFileRepository>(
        () => _i31.ViewFileRepositoryImpl(apiService: gh<_i11.ApiService>()));
    gh.lazySingleton<_i32.AgentApplicationsRepository>(() =>
        _i33.AgentApplicationsRepositoryImpl(
            apiService: gh<_i11.ApiService>()));
    gh.lazySingleton<_i34.DeRegisterFingerprint>(
        () => _i34.DeRegisterFingerprint(gh<_i16.ProfileRepository>()));
    gh.lazySingleton<_i35.GetAgentApplications>(() =>
        _i35.GetAgentApplications(gh<_i32.AgentApplicationsRepository>()));
    gh.lazySingleton<_i36.GetAgentDetails>(
        () => _i36.GetAgentDetails(gh<_i16.ProfileRepository>()));
    gh.lazySingleton<_i37.LaunchDetails>(
        () => _i37.LaunchDetails(gh<_i25.SplashScreenRepository>()));
    gh.lazySingleton<_i38.LoginByFP>(
        () => _i38.LoginByFP(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i39.LoginByMpin>(
        () => _i39.LoginByMpin(gh<_i14.MPINRepository>()));
    gh.lazySingleton<_i40.Logout>(
        () => _i40.Logout(gh<_i16.ProfileRepository>()));
    gh.lazySingleton<_i41.SaveFile>(
        () => _i41.SaveFile(gh<_i19.SaveFileRepository>()));
    gh.lazySingleton<_i42.SaveSignature>(
        () => _i42.SaveSignature(gh<_i21.SaveSignatureRepository>()));
    gh.lazySingleton<_i43.ViewFile>(
        () => _i43.ViewFile(gh<_i30.ViewFileRepository>()));
    return this;
  }
}

class _$MAUEngineModule extends _i44.MAUEngineModule {}

...
class _$ResponseModelImpl implements _ResponseModel {
  ...
  @override
  String toString() {
    return 'ResponseModel(header: $header, body: $body, status: $status)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, header, const DeepCollectionEquality().hash(body), status);
...
abstract class _ResponseModel implements ResponseModel {
  const factory _ResponseModel(
      ...
      @JsonKey(name: "b") final dynamic body,
      @JsonKey(name: "s") final StatusModel? status}) = _$ResponseModelImpl;

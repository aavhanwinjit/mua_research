...
VerifyMPINRequestModel verifyMPINRequestModelFromJson(String str) => VerifyMPINRequestModel.fromJson(json.decode(str));

String verifyMPINRequestModelToJson(VerifyMPINRequestModel data) => json.encode(data.toJson());
...
class VerifyMPINRequestModel with _$VerifyMPINRequestModel {
  ...
  factory VerifyMPINRequestModel.fromJson(Map<String, dynamic> json) => _$VerifyMPINRequestModelFromJson(json);
}

...
import 'package:ekyc/widgets/app_phone_text_form_field.dart';
import 'package:ekyc/widgets/buttons/app_primary_button.dart';
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            AppPrimaryButton(
              primaryBtnonTap: () {},
              primaryBtnlabel: Strings.loginButtonTitle,
            ),
            SizedBox(height: 24.h),
            _subTitle(),
          ],

...
@lazySingleton
class GetPORDocumentTypes implements UseCase<GetPorDocumentTypesResponseModel, Null> {
  final MasterDataRepository masterDataRepository;
  GetPORDocumentTypes(this.masterDataRepository);

  @override
  Future<Either<Failure, GetPorDocumentTypesResponseModel>> call(Null params) async {
    return await masterDataRepository.getPORDocumentType();
  }
}

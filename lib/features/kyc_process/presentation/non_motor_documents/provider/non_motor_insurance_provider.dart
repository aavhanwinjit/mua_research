...
final nonMotorInsuranceProofFilePathProvider =
    StateProvider<String?>((ref) => null);
final insuredDocProofFilePathProvider = StateProvider<String?>((ref) => null);

final nonMotorInsuranceDocsTypesListLoading =
    StateProvider<bool>((ref) => false);

final selectedNonMotorInsuranceDocTypeProvider =
    StateProvider<NonMotorInsuranceDocumentTypeModel?>((ref) => null);

final nonMotorInsuranceDocOCRLoadingProvider =
    StateProvider<bool>((ref) => false);

final nonMotorInsuranceDocOCRApiResponse =
    StateProvider<ScanDocumentResponseBody?>((ref) => null);

final nonMotorInsuranceOtherNameProvider =
    StateProvider<String?>((ref) => null);

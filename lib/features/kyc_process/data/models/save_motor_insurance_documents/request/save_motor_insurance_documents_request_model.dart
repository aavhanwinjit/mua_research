...
SaveMotorInsuranceDocumentsRequestModel
    saveMotorInsuranceDocumentsRequestModelFromJson(String str) =>
        SaveMotorInsuranceDocumentsRequestModel.fromJson(json.decode(str));

String saveMotorInsuranceDocumentsRequestModelToJson(
        SaveMotorInsuranceDocumentsRequestModel data) =>
    json.encode(data.toJson());

@freezed
class SaveMotorInsuranceDocumentsRequestModel
    with _$SaveMotorInsuranceDocumentsRequestModel {
  ...
  factory SaveMotorInsuranceDocumentsRequestModel.fromJson(
